...
public class FileUploadUtil {
	...
	public static String uploadFile(String uploadPath, String originalName, byte[] fileData) throws IOException {
		...
		if(MediaTypeCheckUtil.getMediaType(formatName) != null) {
	...
	private static String makeThumbnail(String uploadPath, String path, String fileName) throws IOException {
		...
		BufferedImage changedImg = Scalr.resize(sourceImg, Scalr.Method.AUTOMATIC, Scalr.Mode.FIT_TO_HEIGHT, 100);
		...
		ImageIO.write(changedImg, formatName.toUpperCase(), newFile);
