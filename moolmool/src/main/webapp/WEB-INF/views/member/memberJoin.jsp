...
<style type="text/css">
.pop-address-search .pop-address-search-inner { background-color:#0275D8; }
input{
	padding: 5px;
}
.error{
    ...
    $("form").validate({
    	...
    	rules: {
            id: {
                ...
                id_rule : true,
                rangelength:[5,20],
                remote : { type: "post", url: "/moolmool/member/idCheck" }
            },
            password: {
            	pwd_rule : true, 
            	rangelength:[6,16],
            ...
            nickName: {
            	required : true,
            	naming_rule : true,
            	remote : { type: "post", url: "/moolmool/member/nickNameCheck" }
            },
            name:{
            	required : true,
            	naming_rule : true
            ...
            email: {
            	required : true,
            	email : true,
            	remote : { type: "post", url: "/moolmool/member/emailCheck" }
            }
    	},
...
<section class="container container-top container-center">
	<div class="vcenter-tb">
		<div class="row vcenter-tc ">
			<form:form action="join" method="post" commandName="memberVO" cssClass="col-md-5 col-sm-12 col-centered well">
  				<form:hidden path="roleCode" value="ROLE_USER"/>
		    	<div class="form-group">
		    		<form:label cssClass="control-label" path="id">아이디</form:label>
		    		<form:input path="id" autocomplete="off" cssClass="form-control" placeholder="아이디를 입력하세요."/>
		    	...
		    	<div class="form-group">
		    		...
		    		<form:input path="nickName" cssClass="form-control" placeholder="닉네임(별명)을 입력하세요."/>
		    	...
		    	<div class="form-group">
		    		...
		    		<input type="tel" class="form-control" id="phone" name="phone" placeholder="(-제외)휴대전화번호 입력하세요.">
  				    <form:errors cssClass="help-block error" path="phone"/>
		    	</div>
		    	<div class="form-group">
		    		<label class="control-label" for="email">EMAIL</label>
		    		<input type="email" class="form-control" id="email" name="email" placeholder="비상연락용 이메일 입력하세요.">
