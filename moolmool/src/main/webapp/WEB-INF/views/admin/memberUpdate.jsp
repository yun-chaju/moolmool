...
$(function(){
    ...
    $("form").validate({
    	...
    	messages : {
            ...
            password: {
            	pwd_rule : "6~16자 영문 대 소문자, 숫자, 특수문자를 조합하여 사용하세요1.",
            	rangelength: "6~16자 영문 대 소문자, 숫자, 특수문자를 조합하여 사용하세요2.",
            	required : "필수 정보입니다."
            },
            rePassword: {
            	required : "필수 정보입니다.",
...
<section>
	...
	<div class="admin-content">
		...
		<div class="row vcenter-tc ">
			<form:form action="${ pageContext.request.contextPath }/member/update/" commandName="memberVO" method="POST" cssClass="col-md-5 col-sm-12 col-centered well">
				<!-- 참조키 연결하면 필요없을듯? -->
  				<form:hidden path="roleCode" value="ROLE_USER"/>
		    	<div class="form-group">
		    		<form:label cssClass="control-label" path="id">아이디</form:label>
		    		<form:input path="id" autocomplete="off" cssClass="form-control" placeholder="아이디를 입력하세요." readonly="readonly"/>
					<form:errors cssClass="help-block" path="id" />
		    	</div>
		    	<div class="form-group">
		    	...
		    	<div class="form-group">
		    		...
		    		<form:input path="nickName" cssClass="form-control" placeholder="닉네임(별명)을 입력하세요." readonly="readonly"/>
					<form:errors cssClass="help-block" path="nickName" />
		    	</div>
		    	<div class="form-group">
		    	...
		    	<div class="form-group">
		    		...
		    		<input type="email" class="form-control" id="email" name="email" placeholder="비상연락용 이메일 입력하세요." value="${memberVO.email}" readonly="readonly">
  					<span class="help-block" id="error_msg"></span>
		    	</div>
		    	<div class="form-group">
