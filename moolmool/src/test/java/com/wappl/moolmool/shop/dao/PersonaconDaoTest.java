...
@Transactional
public class PersonaconDaoTest {
	
	@Autowired
	private PersonaconDao dao;
	
	@Test
	public void testGetDaoInstance() throws Exception {
		assertThat(dao, instanceOf(PersonaconDao.class));
	}
	...
	public void testInsertPersonacon() throws Exception {
		PersonaconVO vo = new PersonaconVO()
				...
				.setPscType("imgs")
				.setPrice(500);
		assertThat(dao.insertPersonacon(vo), is(1));
	}
	...
	public void testGetPersonaconList() throws Exception {
		int memNo = 1;
		int page = 1;
		assertThat(dao.getPersonaconList(memNo, page).size(), is(greaterThanOrEqualTo(1)));
	}
	
	@Test
	public void testGetPersonaconDetail() throws Exception {
		int pscNo = 1;
		assertThat(dao.getPersonaconDetail(pscNo), instanceOf(PersonaconVO.class));
	}
	...
	public void testUpdatePersonacon() throws Exception {
		PersonaconVO vo = new PersonaconVO()
				...
				.setPscType("imgs")
				.setPrice(500);
		assertThat(dao.updatePersonacon(vo), is(1));
	}
	
	@Test
	public void testDeletePersonacon() throws Exception {
		int pscNo = 1;
		assertThat(dao.deletePersonacon(pscNo), is(1));
	}
