...
public class MemberServiceImplTest {
	...
	public void testDaoSession() throws Exception {
		assertThat(MemberService, is(notNullValue()));
	}
	...
	public void testloginCheck() throws Exception {
		...
		assertThat(MemberService.loginCheck(vo), is(notNullValue()));
	}
	...
	public void testInsertMember() throws Exception {
		...
		assertThat(MemberService.insertMember(vo), is(1));;*/
	}
	...
	public void testDeleteMember() throws Exception {
		...
		assertThat(MemberService.deleteMember(vo), is(1));
	}
	...
	public void testUpdateMember() throws Exception {
		...
		assertThat(MemberService.updateMember(vo), is(1));
	}
